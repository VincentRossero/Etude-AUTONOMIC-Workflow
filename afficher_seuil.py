...
raw_tco2, srate = physio.read_one_channel('EEG_10.TRC',format='micromed', channel_name='tCO2+')
raw_Spo2, srate = physio.read_one_channel('EEG_10.TRC',format='micromed', channel_name='SpO2+')
...
above_threshold_tco2 = raw_tco2 > threshold_high_tcO2
